...
public class TransactionService : ITransactionService
{
    ...
    {
        var transactions = await _unitOfWork.TransactionRepository.GetAll().Include(x=>x.Account).Include(x=>x.ReceiverAccount).OrderByDescending(x=>x.TransactionTime).ToListAsync();
